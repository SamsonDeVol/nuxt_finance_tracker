...
const supabase = createClient(
  ...
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpzemZ5anJla2JxeXRpa2lmaXFkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNDA1NDI5OSwiZXhwIjoyMDQ5NjMwMjk5fQ.jFTqLlSxImRJrdt00ShENdfTIOnP5IELL2wC8wyCMs0', {
...
seedTransactions().catch(console.error)// seedTransactions().catch(console.error)