<template>
  <UForm :state="state" :schema="schema" @submit.prevent="saveProfile">
    ...
    help="You will receive a confirmation email on both the old and new addresses">
      <UInput v-model="state.email"/>
    </UFormGroup>
    <UButton type="submit" color="black" variant="solid" label="Save" :loading="pending" :diabled="pending"/>
  </UForm>
</template>
